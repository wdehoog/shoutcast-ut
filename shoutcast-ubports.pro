...
UBUNTU_TRANSLATION_DOMAIN="shoutcast-ubports.wdehoog"
...
aptest.commands = bash $$PWD/shoutcast-ubports/tests/autopilot/run
aptest.depends  = sub-shoutcast-ubports

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/shoutcast-ubports/tests/unit 
unittest.depends  = sub-shoutcast-ubports
